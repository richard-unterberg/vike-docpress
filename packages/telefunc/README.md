...
`telefunc` is the Vike docs application inside this pnpm workspace monorepo.
...
![screenshot 1](https://github.com/richard-unterberg/vike-docpress/blob/master/packages/telefunc/public/preview/preview-1.jpg?raw=true)
...
This package keeps docs authoring content-only while still rendering docs as real Vike pages.
